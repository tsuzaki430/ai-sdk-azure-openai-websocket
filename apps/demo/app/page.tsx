        ...
        <div className="sidebar-body">
          ...
          <section>
            ...
            <DiffBlock lines={[
              ...
              { text: "import { createAzureOpenAI }", type: 'context' },
              { text: "  from '@/lib/azure-openai';", type: 'context' },
